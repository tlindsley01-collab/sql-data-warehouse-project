...
Script Purpose:
  ...
  This script is nearly identical to the ddl used to create the bronze layer, but 
  with the addition of a column to capture creation date meta data for each table 
====================================================================================
*/
...
CREATE TABLE silver.crm_prd_info (
	...
	--CREATE SILVER TABLE FOR sales_details data 
...
--ERP SILVER table creation--
--CREATE SILVER TABLE FOR cust_az12 
...
CREATE TABLE silver.erp_cust_az12 (
	...
	--CREATE SILVER TABLE FOR loc_a101 --HAVE NOT EXECUTED YET
...
CREATE TABLE silver.erp_loc_a101 (
	...
	--CREATE SILVER TABLE FOR px_cat_g1v2 --HAVE NOT EXECUTED YET
